...
const packages = [
  {
    ...
    price: 300,
    color: '#4a9e7d',
    tagline: 'Get started with social presence',
    features: [
    ...
    ideal: 'New businesses building their first online presence.',
  },
  {
    tier: 'spark',
    name: 'Spark',
    price: 600,
    color: '#3a8bc2',
    tagline: 'Ignite your local marketing',
    features: [
      'Everything in Social Essentials',
    ...
    ideal: 'Businesses ready to get found on Google and build credibility.',
  },
  {
    tier: 'growth',
    name: 'Growth',
    price: 1200,
    color: '#c9a96e',
    tagline: 'Accelerate leads and revenue',
    features: [
      'Everything in Spark',
      'Full SEO (15+ keywords)',
    ...
    ideal: 'Businesses serious about generating consistent leads every month.',
  },
  {
    tier: 'scale',
    name: 'Scale',
    ...
    ideal: 'Established businesses wanting aggressive growth and full-service marketing.',
  },
]
