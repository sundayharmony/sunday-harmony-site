            ...
            <div>
              ...
              <div className="mt-4">
                ...
                <div className="text-sm text-brand-text">
                  {client?.start_date ? (new Date(client.start_date).toLocaleDateString ? new Date(client.start_date).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' }) : '—') : '—'}
                </div>
              </div>
            </div>
          </div>
