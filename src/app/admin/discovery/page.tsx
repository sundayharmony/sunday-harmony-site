...
export default function DiscoveryPage() {
  ...
  return (
    <div>
      ...
      {tab === 'script' && (
        <div>
          <div className="bg-[rgba(201,169,110,0.06)] border border-[rgba(201,169,110,0.15)] rounded-xl p-4 mb-5">
          ...
          {interviewScript.map((sec, si) => (
            <div key={si} className="mb-5">
              ...
              {sec.questions.map((item, qi) => {
                ...
                return (
                  <div key={qi} className={`ml-4 mb-2 rounded-lg border transition-all ${isOpen ? 'bg-[rgba(255,255,255,0.04)] border-[rgba(201,169,110,0.2)]' : 'bg-[rgba(255,255,255,0.02)] border-[rgba(255,255,255,0.06)]'}`}>
                    <div onClick={() => setExpandedQ(isOpen ? null : key)} className="p-3 cursor-pointer flex items-start gap-2">
                      ...
                      <p className="flex-1 text-sm text-[#d8d6d1] italic leading-relaxed">&ldquo;{item.q}&rdquo;</p>
                    ...
                    {isOpen && (
                      <div className="px-3 pb-3 border-t border-[rgba(255,255,255,0.04)]">
                        <div className="grid grid-cols-2 gap-3 mt-3">
                          <div className="bg-[rgba(201,169,110,0.06)] rounded-lg p-3">
                          ...
                          <div className="bg-[rgba(74,158,125,0.06)] rounded-lg p-3">
