    ...
    <div>
          ...
          >
            <div className="flex items-center justify-between mb-1">
              ...
              {(p as { popular?: boolean }).popular && (
                <span className="text-[8px] font-bold uppercase px-1.5 py-0.5 rounded-full bg-[rgba(201,169,110,0.15)] text-brand-gold">Popular</span>
              )}
            </div>
      ...
      <div className="grid grid-cols-[1fr_320px] gap-6 mb-8">
            ...
            {pkg.services.map((s, i) => (
              <div
                ...
                className={`flex items-start gap-3 p-3 rounded-lg ${
                  s.included
                    ? 'bg-[rgba(74,158,125,0.05)] border border-[rgba(74,158,125,0.1)]'
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[rgba(74,158,125,0.06)] border border-[rgba(74,158,125,0.15)] rounded-xl p-5">
      ...
      <div className="bg-[rgba(201,169,110,0.06)] border border-[rgba(201,169,110,0.15)] rounded-2xl p-6">
        ...
        <div className="grid grid-cols-2 gap-2">
          {footInDoorOffer.steps.map((step, i) => (
            <div key={i} className="flex items-start gap-2 p-2.5 rounded-lg bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.04)]">
        ...
        <div className="mt-4 p-3 rounded-lg bg-[rgba(74,158,125,0.08)] border border-[rgba(74,158,125,0.15)]">
