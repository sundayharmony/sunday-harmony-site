    ...
    <section className="py-24" id="process">
      <div className="max-w-[1100px] mx-auto px-7">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12 relative">
          ...
          <div className="hidden lg:block absolute top-10 left-14 right-14 h-px bg-gradient-to-r from-brand-gold to-[rgba(201,169,110,0.1)]" />

          {processSteps.map((step) => (
            <div key={step.num} className="text-center relative">
              <div className="w-[52px] h-[52px] rounded-full mx-auto mb-5 bg-[rgba(201,169,110,0.1)] border-2 border-[rgba(201,169,110,0.25)] flex items-center justify-center font-serif text-xl font-extrabold text-brand-gold relative z-10">
                {step.num}
              </div>
